...
The catalogue is the most comprehensive database of New Zealand-based researchers' Antarctic and Southern Ocean data. The system is designed to disseminate metadata to NASA's [Antarctic Metadata Directory (AMD)](https://search.earthdata.nasa.gov/search?portal=amd) and other domain-specific catalogues, tools, and products including [EMODnet](https://emodnet.ec.europa.eu/geonetwork) and [SOOSmap](http://www.soosmap.aq/). This approach is consistent with data centres at other polar programmes (USAP, BAS, AADC), contributing to the free and open exchange of Antarctic observations and results.
